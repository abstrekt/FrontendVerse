...
export default function ArchivedView({
  ...
  const pools = { testPrep, questions, learnings, cssLearnings, reactLearnings, reactGuide, advancedReact, hldLearnings, algorithmLearnings, codingQuestions, outputQuestions };
